...
from nnutils import adaptive_avgpool_2d
...
class AdaptiveAvgPool2d(torch.nn.Module):
    ...
    def forward(self, input, batch_sizes=None):
        return adaptive_avgpool_2d(input, self.output_size, batch_sizes)
...
# Both will work without modification
out1 = pool(x1)
out2 = pool(x2)
